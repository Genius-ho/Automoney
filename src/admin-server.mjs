...
import { validateManualWorkflowMetadata } from './manual-ai/workflow-service.mjs';
...
function sendWorkflowError(response,error){const statuses={DRAFT_NOT_FOUND:404,MAIN_IMAGE_PROMPT_MISSING:409,MAIN_IMAGE_PROMPT_STALE:409,MAIN_IMAGE_PROMPT_INVALID:422,SOURCE_MAIN_IMAGE_MISSING:409,PROMPT_REQUEST_MISMATCH:409,PROMPT_REVISION_MISMATCH:409,MANUAL_IMAGE_NOT_FOUND:404,UPLOAD_TOO_LARGE:413,IMAGE_TOO_LARGE:413,UNSUPPORTED_IMAGE_FORMAT:415,IMAGE_MIME_MISMATCH:415,CORRUPT_IMAGE:422,IMAGE_DIMENSIONS_INVALID:422,IMAGE_PIXELS_INVALID:422,IMAGE_NOT_SQUARE:422,DERIVATIVE_TOO_LARGE:422};sendJson(response,statuses[error.code]||400,{error:error.message||String(error),code:error.code||'MANUAL_WORKFLOW_ERROR'});}
